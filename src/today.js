...
// 厨房共有メモのカテゴリ（Firestore の category に key を保存）
const KITCHEN_NOTE_CATEGORIES = [
...
function kitchenCategoryLabel(key) {
  ...
  return (
    <div style={{padding:"1rem .85rem",maxWidth:720,margin:"0 auto"}} className="hb-view">
      ...
      <div style={{marginBottom:"1.25rem"}}>
        <div style={{...S.secTitle, borderBottomColor:"rgba(126,200,127,0.25)", color:"rgba(126,200,127,0.95)"}}>🍳 厨房共有</div>
