      ...
      <div style={S.hdr} className="hb-hdr">
        <div style={{display:"flex",alignItems:"center",gap:".75rem"}}>
          ...
          <div style={S.logo} className="hb-logo" onClick={goHome} role="button" title="トップへ">
            HONEY BEE <small style={S.logoSm}>{view==="home"?"Operation":view.startsWith("events")?"Event Manager":""}</small>
          </div>
        </div>
      ...
      {view==="home"&&(
        <div style={{padding:"2.5rem 2rem",maxWidth:1100,margin:"0 auto"}} className="hb-view">
          <div style={{textAlign:"center",marginBottom:"2.5rem"}}>
            <div style={{fontFamily:"Georgia,serif",fontSize:"1.4rem",color:"#c9a84c",letterSpacing:".25em",marginBottom:".4rem"}}>OPERATION CENTER</div>
            <div style={{fontSize:".8rem",color:"rgba(240,232,208,0.4)",letterSpacing:".15em"}}>業務ポータル — 各モジュールへアクセス</div>
          </div>
