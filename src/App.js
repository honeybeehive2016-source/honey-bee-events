...
export default function App() {
  ...
  const [reservationInitialFilter, setReservationInitialFilter] = useState(null);
    ...
    <div style={S.app}>
      ...
      {view==="today"&&(
        <TodayModule
          ...
          onGoReservations={()=>{
            setReservationInitialFilter("today");
      ...
      {view==="reservation"&&(
        <ReservationModule
          ...
          initialFilter={reservationInitialFilter}
        />
      )}
